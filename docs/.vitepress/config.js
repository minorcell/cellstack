      ...
      "/blog/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "从榨汁机模型理解哈希算法：原理、应用与哈希表解析", link: "/blog/2025/06_hash" },
          ],
        },
        {
          text: "客户端",
          items: [
            ...
            { text: "你不知道的 Vue Style 黑魔法", link: "/blog/2025/01_vuestyle" },
        ...
        },
        {
          text: "开发工具",
          items: [
            { text: "VSCode 自动格式化：ESLint 与 Prettier", link: "/blog/2025/02_vscodeformat" },
          ],
        },
      ],
      "/me/": [
